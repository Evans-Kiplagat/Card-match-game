...
namespace CardMatchGame
{
    public class MatchCard : MonoBehaviour
    {
        ...
        private void ChangeSprite()
        {
            ...
            if (flipped)
                img.sprite = UniversalGameManager.Instance.GetSprite(spriteID);
            else
                img.sprite = UniversalGameManager.Instance.CardBack();
        }
        // call fade animation
        ...
        public void CardBtn()
        {
            ...
            if (!UniversalGameManager.Instance.canClick()) return;
            Flip();
        ...
        private IEnumerator SelectionEvent()
        {
            ...
            UniversalGameManager.Instance.cardClicked(spriteID, id);
        }
    }
}
